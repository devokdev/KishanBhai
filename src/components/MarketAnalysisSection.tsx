...
// Import the new PathwayTracker component
import { PathwayTracker } from './pathway/PathwayTracker';
...
export default function MarketAnalysisSection() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full p-4 sm:p-8">
      {/* --- Column 1: Pathway Tracker --- */}
      <div className="lg:col-span-1">
        <PathwayTracker />
      </div>

      {/* --- Column 2: Your Original Market Analysis Card --- */}
